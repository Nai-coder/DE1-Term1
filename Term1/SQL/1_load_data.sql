...
-- drop table WDI_CO2_emissions;

CREATE TABLE wdi_co2_emissions
(`Country Name` VARCHAR(100) NOT NULL,
`Country Code` VARCHAR(10),
`Indicator Name` VARCHAR(40),
...
LOAD DATA INFILE '/tmp/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_4666338.csv'
INTO TABLE WDI_CO2_emissions
...
;
-- check import was ok
SELECT * FROM wdi_co2_emissions;

-- import table 2: hydroelectric
CREATE TABLE wdi_hydroelec
(`Country Name` VARCHAR(100) NOT NULL,
`Country Code` VARCHAR(10),
...
LOAD DATA INFILE '/tmp/API_EG.ELC.HYRO.ZS_DS2_en_csv_v2_4538181.csv'
INTO TABLE wdi_hydroelec
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 5 LINES
(`Country Name`, `Country Code`, `Indicator Name`, `Indicator Code`,
...
-- check import was ok
SELECT * FROM wdi_hydroelec;

-- import table 3: nuclear electricity production
...
-- import table 4: oil, gas and coal electricity production
...
-- import table 5: renewables electricity production
CREATE TABLE wdi_renewables
(`Country Name` VARCHAR(100) NOT NULL,
`Country Code` VARCHAR(10),
`Indicator Name` VARCHAR(85),
`Indicator Code` VARCHAR(15),
`y1960` DOUBLE,`y1961` DOUBLE,`y1962` DOUBLE,`y1963` DOUBLE,`y1964` DOUBLE,
`y1965` DOUBLE,`y1966` DOUBLE,`y1967` DOUBLE,`y1968` DOUBLE,`y1969` DOUBLE,
`y1970` DOUBLE,`y1971` DOUBLE,`y1972` DOUBLE,`y1973` DOUBLE,`y1974` DOUBLE,
...
LOAD DATA INFILE '/tmp/API_EG.ELC.RNWX.ZS_DS2_en_csv_v2_4530894.csv'
INTO TABLE wdi_renewables
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 5 LINES
(`Country Name`, `Country Code`, `Indicator Name`, `Indicator Code`,
...
-- check import was ok
SELECT * FROM wdi_renewables;

-- import table 6: GDP by country
CREATE TABLE wdi_gdp
(`Country Name` VARCHAR(100) NOT NULL,
`Country Code` VARCHAR(10),
`Indicator Name` VARCHAR(40),
`Indicator Code` VARCHAR(20),
`y1960` DOUBLE,`y1961` DOUBLE,`y1962` DOUBLE,`y1963` DOUBLE,`y1964` DOUBLE,
`y1965` DOUBLE,`y1966` DOUBLE,`y1967` DOUBLE,`y1968` DOUBLE,`y1969` DOUBLE,
`y1970` DOUBLE,`y1971` DOUBLE,`y1972` DOUBLE,`y1973` DOUBLE,`y1974` DOUBLE,
`y1975` DOUBLE,`y1976` DOUBLE,`y1977` DOUBLE,`y1978` DOUBLE,`y1979` DOUBLE,
...
LOAD DATA INFILE '/tmp/API_NY.GDP.MKTP.PP.CD_DS2_en_csv_v2_4662081.csv'
INTO TABLE wdi_gdp
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 5 LINES
...
-- import table 7: Population data by country
CREATE TABLE wdi_pop
(`Country Name` VARCHAR(100) NOT NULL,
`Country Code` VARCHAR(10),
`Indicator Name` VARCHAR(40),
`Indicator Code` VARCHAR(15),
...
LOAD DATA INFILE '/tmp/API_SP.POP.TOTL_DS2_en_csv_v2_4666497.csv'
INTO TABLE wdi_pop
FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 5 LINES
